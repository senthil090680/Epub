...
//$dataquery				=		"SELECT settingId,presetName,presetSet,epubVersion,outputType,bookTitle,coverImage,presetName,resol,supportDevice,fixedLay,openSpread,interActive,specificFont,fontName,oriLock,epubFolder,pdfFile,pdfPages,createdDate FROM ".EPUB_SET."";
      ...
      <form name="epublibform" id="epublibform" method="post" action="epubeditview.php" enctype="multipart/form-data">
        ...
        <table width="100%" border="1" cellpadding="10" cellspacing="0" class="frmTbl">
            ...
            <tr>
                ...
                <td align="center" ><a href="javascript:void(0)" onclick="previewshow('<?php echo EPUB_FOLDER. "/".$datarow['epubFolder']."/OPS/"; ?>','<?php echo RELATIVE_PATH."/"; ?>','<?php echo base64_encode($datarow['settingId']); ?>','<?php echo PREVIEW_TEMP."/"; ?>');"><img src="images/preview.png" alt="PREVIEW" border="0" title="Preview"/></a></td>
